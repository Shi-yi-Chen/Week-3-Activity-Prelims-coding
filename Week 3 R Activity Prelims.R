...
ShiyiTitanic <- Titanic
ShiyiTitanic <- as.data.frame(ShiyiTitanic)
...
Sex <- ShiyiTitanic$Sex
Age <- ShiyiTitanic$Age
...
NewDataFrame <- data.frame(Sex = Sex, Age = Age)
...
ggplot(ShiyiTitanic, aes(Survived)) +
  geom_bar()
